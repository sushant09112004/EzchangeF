          ...
          <div className="bg-gray-800 p-6 rounded shadow-lg max-w-2xl w-full relative">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 p-4">
                <h2 className="text-xl text-center mb-5">Welcome Back!</h2>
                <form onSubmit={handleSignIn} className="space-y-4">
                  ...
                  <input
                    ...
                    required
                  />
                  <button type="submit" className="bg-purple-600 font-semibold w-full py-2 justify-items-center rounded text-white">Login</button>
                </form>
